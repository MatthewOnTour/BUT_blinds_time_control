            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Required("time_up", default=self.config_entry.data.get("time_up")): vol.All(vol.Coerce(int), vol.Range(min=0)),
                    vol.Required("time_down", default=self.config_entry.data.get("time_down")): vol.All(vol.Coerce(int), vol.Range(min=0)),
                    vol.Required("tilt_open", default=self.config_entry.data.get("tilt_open")): vol.All(vol.Coerce(int), vol.Range(min=0)),
                    vol.Required("tilt_closed", default=self.config_entry.data.get("tilt_closed")): vol.All(vol.Coerce(int), vol.Range(min=0)),
                }
            ),
        )